//
//  TntViewRenderer+MetalDynamicTiles.swift
//  HPIView
//
...
class DynamicTileMetalTntViewRenderer: MetalTntRenderer {
...
extension DynamicTileMetalTntViewRenderer {
...
private extension DynamicTileMetalTntViewRenderer.MapResources {
...
private extension DynamicTileMetalTntViewRenderer.TaTntTileSet {
    
    static let tilesPerTexture = 2048
    private typealias `Self` = DynamicTileMetalTntViewRenderer.TaTntTileSet
...
private extension DynamicTileMetalTntViewRenderer.TakTntTerrainSet {
